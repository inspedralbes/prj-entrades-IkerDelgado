    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-200">
            <div className="max-w-3xl mx-auto px-6 py-16">
                ...
                <h1 className="text-4xl font-black text-white mb-2">Termes de Servei</h1>
                ...
                <div className="space-y-8 text-slate-400 text-sm leading-relaxed">
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">1. Acceptació dels termes</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">2. Descripció del servei</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">3. Comptes d'usuari</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">4. Compra d'entrades</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">5. Conducta de l'usuari</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">6. Limitació de responsabilitat</h2>
                    ...
                    <section>
                        <h2 className="text-white text-lg font-bold mb-3">7. Contacte</h2>
                        <p>Per a qualsevol consulta sobre aquests termes, pots contactar-nos a <a href="mailto:info@tickethub.cat" className="text-indigo-400 hover:text-indigo-300">info@tickethub.cat</a>.</p>
                    </section>
                </div>
            </div>
        </div>
